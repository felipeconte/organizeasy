      ...
      <header className="sticky top-0 z-50 bg-white/85 backdrop-blur-md border-b border-slate-200/80 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            <Link
              href="/portal/login"
              className="flex items-center gap-1.5 px-3 py-2 sm:px-3.5 sm:py-2 rounded-xl text-xs font-bold text-blue-700 bg-blue-50/90 hover:bg-blue-100 border border-blue-200/90 transition-all shadow-2xs"
            >
              <UserCheck className="w-3.5 h-3.5 text-blue-600" />
              <span className="hidden sm:inline">Acompanhar meu projeto</span>
              <span className="sm:hidden">Portal</span>
            </Link>
            <Link
              href="/login"
              className="px-3 py-2 rounded-xl text-xs font-bold text-slate-700 hover:text-blue-600 hover:bg-slate-100 transition-all hidden sm:inline-block"
            >
              Área do Escritório
            </Link>
            <Link
              href="/cadastro"
              className="flex items-center gap-1.5 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white text-xs font-semibold transition-all shadow-sm shadow-blue-500/25"
            >
