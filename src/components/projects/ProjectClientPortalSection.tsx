...
export { default as ProjectClientPortalModal } from './ProjectClientPortalModal'
...
export interface ProjectClientPortalSectionProps {
  projectId: string
  projectCode?: string
  orgSlug?: string
  portalToken?: string
...
export default function ProjectClientPortalSection({
  projectId,
  projectCode,
  orgSlug,
  portalToken,
  linkedClients = [],
}: ProjectClientPortalSectionProps) {
    ...
    <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-xs space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-5 border-b border-slate-100">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center shrink-0 border border-blue-100/60 shadow-xs">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Links de acesso e credenciais seguras dos clientes envolvidos neste projeto.
            </p>
          </div>
        </div>
      </div>

      {/* 2. Grid de Links do Portal (Link Direto do Projeto + Link Central do Escritório) */}
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold transition-all shadow-xs cursor-pointer"
              >
                {copiedProjectLink ? (
                  <>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-white hover:bg-slate-100 text-slate-700 border border-slate-200 text-xs font-bold transition-all cursor-pointer"
                  title="Abrir em nova aba"
                >
                  <ExternalLink className="w-3.5 h-3.5" />
                </a>
      ...
      {/* 3. Clientes Vinculados & Gestão de Códigos de Acesso */}
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Gerencie e reenvie as credenciais de acesso por e-mail com sigilo total.
            </p>
          </div>
        </div>
